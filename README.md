...
1. [linear models with lm](https://win-vector.com/2018/09/01/r-tip-how-to-pass-a-formula-to-lm/)
1. [Fixed Effects Linear Regressions](https://lost-stats.github.io/Model_Estimation/OLS/fixed_effects_in_linear_regression.html)
 - [lfe package](https://rdrr.io/cran/lfe/man/felm.html)
 - [fixest package](https://cran.r-project.org/web/packages/fixest/vignettes/fixest_walkthrough.html)
1. [hierarhical models with lmer](http://doingbayesiandataanalysis.blogspot.com/2019/07/shrinkage-in-hierarchical-models-random.html)
1. [broom for collecting coefficients](https://cran.r-project.org/web/packages/broom/vignettes/broom.html)

## D-in-D and Synthetic Control

1. [diff-in-diff w/ did package](https://bcallaway11.github.io/did/articles/did-basics.html)
1. [synth control with synthdid](https://github.com/synth-inference/synthdid)
...
- [Chris Hanretty's 2 day course on R for Stata](http://chrishanretty.co.uk/conveRt/#1)
